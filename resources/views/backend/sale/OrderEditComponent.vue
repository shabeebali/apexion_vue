...
export default{
    ...
    mounted(){
        axios.get('sale/orders/edit/'+this.$route.params.id).then((response)=>{
            this.id = response.data.id
            this.discount = response.data.discount
            this.salesPersonSelect = response.data.salesperson_id
            this.userSelect = response.data.user_id
            this.gstSwitch = String(parseInt(response.data.gst_included))
            ...
            this.pricelistSelect = response.data.pricelist_id
            this.updateTotal()
        })
    ...
    methods:{
        ...
        save(){
            this.routerCheck = false
            var fD = new FormData()
            if(typeof this.customerSelect != 'object'){
